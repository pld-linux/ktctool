...
Ktctool to graficzny interfejs do zarządzania pasmem sieci w Linuksie.
Istnieje już w tym celu działający z linii poleceń program tc. Ktctool
ma być graficznym interfejsem użytkownika do tc. tc jest częścią
iproute2 i steruje obsługą QoS (Quality of Service - jakości usług) w
jądrze Linuksa.
